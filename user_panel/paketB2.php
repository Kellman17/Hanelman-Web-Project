                ...
                <div class="col-lg-6">
                    <form action="" method="post">
                        <div class="product__details__text">
                            ...
                            <h4>Sekantor</h4>
                            <input type="hidden" name="product" value="SEKANTOR"/>
                            <input type="hidden" name="images" value="img/shop/Paket-B1.png"/>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <span>Quantity :</span>
                                    <ul>
                                        <li><input type="radio" name="radio_quantity" value="50"> 50</li>
