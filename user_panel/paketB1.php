<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if ($_POST['radio_quantity'] == 50 && $_POST['radio_duration'] == "1 Week") {
            $total = 1000000;
        } else if ($_POST['radio_quantity'] == 100 && $_POST['radio_duration'] == "1 Week" ) {
            $total = 2000000; 
        }else if ($_POST['radio_quantity'] == 200 && $_POST['radio_duration'] == "1 Week"){
            $total = 5000000;

        }else if ($_POST['radio_quantity'] == 50 && $_POST['radio_duration'] == "2 Weeks"){
            $total = 2000000;
        }else if ($_POST['radio_quantity'] == 100 && $_POST['radio_duration'] == "2 Weeks"){
            $total = 4000000;
        }else if ($_POST['radio_quantity'] == 200 && $_POST['radio_duration'] == "2 Weeks"){
            $total = 10000000;

        }else if ($_POST['radio_quantity'] == 50 && $_POST['radio_duration'] == "4 Weeks"){
            $total = 4000000;
        }else if ($_POST['radio_quantity'] == 100 && $_POST['radio_duration'] == "4 Weeks"){
            $total = 8000000;
        }else if ($_POST['radio_quantity'] == 200 && $_POST['radio_duration'] == "4 Weeks"){
            $total = 20000000;
        }
...
<head>
    ...
    <title>Package B | Hanelman Catering</title>
                ...
                <div class="col-lg-6">
                    <div class="product__details__img">
                        <div class="product__details__big__img">
                            <img class="big_img" src="img/shop/Paket-B1.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <div class="product__label">Paket B</div>
                        <h4>Sekantor</h4>
                        <h5>Start From IDR 1.000.000</h5>
                        <div class="quantity">
                            <div class="row">
                                <div class="col-lg-6">
                                    <span>Quantity :</span>
                                    <ul>
                                        <li><input type="radio" name="radio-50" value="50"> 50</li>
                                        <li><input type="radio" name="radio-100" value="100"> 100</li>
                                        <li><input type="radio" name="radio-200" value="200"> 200</li>
                                    </ul>
                                </div>
                                <div class="col-lg-6">
                                    <span>Duration :</span>
                                    <ul>
                                        <li><input type="radio" name="radio-1W" value="1 Week"> 1 Week</li>
                                        <li><input type="radio" name="radio-2W" value="2 weeks"> 2 Weeks</li>
                                        <li><input type="radio" name="radio-4W" value="4 Weeks"> 4 Weeks</li>
                                    </ul>
                                </div>
                            </div>  
                        </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-8">
                                    <p>Sekantor is a package to make your office more flavorful and make your employees feel satisfied. 
                                        This package has various duration options. The minimum quantity that can be ordered for this package is 50 servings.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="shop__pagination">
                            <a href="paketB.php">1</a>
                            <a href="paketB1.php">2</a>
                            <a href="paketB2.php">3</a>
                            <a href="paketB3.php">4</a>
