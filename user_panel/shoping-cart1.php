            ...
            <div class="row">
                        ...
                        ?> 
                            <tbody>
                                <tr>
                                    ...
                                    <td class="cart__close"><a href="delete.php?id_keranjang=<?php echo $row['id_keranjang']; ?>"><span class="icon_close"></span></a></td>
                                </tr>
                            </tbody>
                <?php
                    $subtotal += $row['Total'];
                ...
                <div class="col-lg-4">
                    <div class="cart__total">
                        <h6>Cart total</h6>
                        <ul>
                            <li>Total <span>Rp. <?php echo $subtotal; ?></span></li>
                        </ul>
